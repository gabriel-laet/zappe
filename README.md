...
| Mic (red) | Whisper pt-BR (hold/tap). `abrir Netflix`, `voltar`, `volume mais`, `mudo`, `ir para Globo`, `sincronizar`. Evdev `KEY_SEARCH` **217** / `KEY_VOICECOMMAND` **582** (locked). See [`docs/voice.md`](docs/voice.md). |
